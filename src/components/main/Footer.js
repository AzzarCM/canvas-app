        ...
        <div className="foot__main-container">
            <div className="foot__upper-div">
                <div className="foot__left-part">
                    <a className="foot__links mb-5" href="/">TERMINOS Y CONDICIONES</a>
                    <a className="foot__links mb-5" href="/">PREGUNTAS FRECUENTES</a>
                    <a className="foot__links mb-5" href="/">AVISO DE PRIVACIDAD</a>
                </div>
                <div className="foot__middle-part">
                    <h3 className="foot__links mb-10">CONTACTO</h3>
                ...
                <div className="foot__right-part">
                    <h3 className="foot__links mb-5">REDES</h3>
                    <p 
                    className="mb-5" 
                    style={{
                        color:'white',
                    ...
                    <div className="foot__social-icons">
                        <a className="mr-2" href="/"><i className="fab fa-facebook-square a-color"></i></a>
                        <a className="mr-2" href="/"><i className="fab fa-twitter-square a-color"></i></a>
                        <a className="mr-2" href="/"><i className="fab fa-instagram-square a-color"></i></a>
                    </div>
                </div>
            </div>
