            ...
            <SearchBar/>
               ...
               {/* { <img alt="imagen" src={uploadImage}/>
                ...
                <div className="upload__text-container">
                    ...
                    <p className="upload__align">Podemos procesar tu pedido vía inbox en instagram, haz click en el botón para que automáticamente estes en nuestro chat y mandes tu foto ¡Te esperamos!</p>
